...
> [Screenshot: Administration button in Terminal header, highlighted]
...
```
┌──────────────────────────────────────────────────────┐
│  HEADER — Logo, back to SQL Terminal, Theme, Language│
├──────────────┬───────────────────────────────────────┤
│              │                                       │
│   SIDEBAR    │   MAIN CONTENT AREA                  │
│              │                                       │
│ • Access     │   (changes based on selected tab)    │
│   Control    │                                       │
│ • Blacklist  │                                       │
│ • Exec Logs  │                                       │
│ • Sys Settings│                                      │
...
> [Screenshot: Access Control tab — statistics cards, filter bar, table, Grant Access button]
...
> [Screenshot: Filter bar with search, category, type, status dropdowns]
...
> [!important] Three distinct actions — important to understand the difference
...
> [Screenshot: Grant Access dialog — all fields visible and labeled]
