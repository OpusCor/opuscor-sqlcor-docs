...
![Page layout overview](./_assets/v1.0/scr2.jpg)

### ⚙️ Administration button
...
![Page layout overview](./_assets/v1.0/scr3.jpg)
![Page layout overview](./_assets/v1.0/scr3_1.jpg)


---

### 🇺🇦 UKR / 🇬🇧 ENG — Language button
...
> [Screenshot: Smart Hints yellow bar with message and "INSERT INTO EDITOR" button]
...
> [Screenshot: Results panel — data table, Export button, row count meta info]
...
> [Screenshot: Export button and CSV download in progress]
...
> [Screenshot: Footer with all 4 indicators labeled]
