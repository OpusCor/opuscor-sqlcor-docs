...
```
┌──────────────────────────────────────────────────────┐
│  HEADER — Logo, Admin, Theme, Language, About        │
├──────────────────────────────────────────────────────┤
│  TOOLBAR — Execute, Clear, Dry Run, DB Indicator     │
├──────────────────────────────────────────────────────┤
│                                                      │
│  EDITOR — Write SQL here (line numbers, highlighting)│
│                                                      │
├──────────────────────────────────────────────────────┤
│  SMART HINTS — yellow bar, appears when relevant     │
├──────────────────────────────────────────────────────┤
│  RESULTS — data table + Export button + row count    │
├──────────────────────────────────────────────────────┤
│  FOOTER — Status · Latency · Memory · Session        │
└──────────────────────────────────────────────────────┘
```
